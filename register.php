...
session_start();
    ...
    if(isset($_POST['register'])){
        ...
        $sql = "INSERT INTO tblnguoidung (`id`, `email`, `password`, `sQuyen`) VALUES (NULL, '$name', '$pass', 'user')";
            ...
            <div class="modal-dialog form_login">
                <div class="modal-content">
                    ...
                    <div class="container login text-center">
                        ...
                        <form action="./register.php" method="post" class=" login_action">
                            ...
                            <button type="submit" name="register" class="btn login_btn">
                                Đăng ký
                            </button>
                        </form>
                    </div>
